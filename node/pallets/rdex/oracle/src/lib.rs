...
pub const DEFAULT_DATA_RESERVE_ERA: u32 = 30;
    ...
    pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        pub fn submit_rtoken_price(origin, symbol: RSymbol, era: u32, price: u128) -> DispatchResult {
            ...
            if prices.len() == requestor::RequestorThreshold::get() as usize {
                ...
                if era > DEFAULT_DATA_RESERVE_ERA {
                    token_price::RTokenPrices::remove(symbol, (era_version, era - DEFAULT_DATA_RESERVE_ERA));
                    token_price::AccountRTokenPrices::<T>::remove((&who, symbol, era_version, era - DEFAULT_DATA_RESERVE_ERA));
                }
        ...
        pub fn submit_fis_price(origin, era: u32, price: u128) -> DispatchResult {
            ...
            if prices.len() == requestor::RequestorThreshold::get() as usize {
                ...
                if era > DEFAULT_DATA_RESERVE_ERA {
                    token_price::FisPrices::remove((era_version, era - DEFAULT_DATA_RESERVE_ERA));
                    token_price::AccountFisPrices::<T>::remove((&who, era_version, era - DEFAULT_DATA_RESERVE_ERA));
                }
